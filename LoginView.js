  ...
  render() {
    return (
      <View style={styles.container}>
        <Text accessible={false} style={styles.bigText}>FitnessTracker</Text>
        <Text accessible={false}>Welcome! Please login or signup to continue.</Text>
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
          <Button
            ...
            accessibilityHint="Navigates user to the Today View"
